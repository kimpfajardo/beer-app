...
import { CheckIcon, MinusIcon, PlusIcon, ShoppingBagIcon } from '@heroicons/react/20/solid'
...
export const AddToShopList = ({ mouseLeft }: { mouseLeft?: boolean }) => {
  ...
  return (
    <div className='relative'>
      ...
      >
        <div
          className={cn('flex items-center space-x-4 opacity-100 transition', !show && 'opacity-0')}
        >
          <button
