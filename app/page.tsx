  ...
  return (
    <main className="bg-amber-600 min-h-screen lg:h-screen lg:px-32">
      ...
      <div className="h-full flex flex-col lg:flex-row lg:items-center ">
        <section className="mx-auto max-w-[640px] lg:max-w-max lg:mx-0">
          <div className="lg:max-w-[640px]">
            ...
            <p className="text-white mb-4 text-lg lg:text-base py-10 lg:py-0 text-center lg:text-left">
        ...
        <div className="lg:hidden bg-amber-500 mt-10" id="about">
      ...
      <div className="hidden lg:block">
        ...
        >
          <div className="font-bold w-32 p-4 cursor-pointer text-white shrink-0">
